    ...
    <div>
      <section className=" dark:bg-gray-900 h-[75vh] flex justify-center items-end ">
        <div className="  mx-auto px-10 py-5 z-10">
          <div className=" shadow-lg rounded-xl relative bg-[#F4F4F5]  items-center max-w-screen-2xl  mx-auto  xl:gap-16 md:grid md:grid-cols-2  lg:px-3">
            <div className="px-8 py-10">
              <h2 className="mb-4 text-[45px]  font-extrabold text-[#27272A] leading-tight dark:text-white">
