...
export const steps = [
  ...
  },
  {
    ...
    description:
      "There are cultural immersion activities in the program where you would learn about the customs, values, and practicalities of living in a foreign land. In addition, personal development workshops and career counselling are given to help students grow both academically and professionally, hence easing the transition process.",
  },
  {
    step: 3,
    heading: "Placement in University and Continuing Support",
    description:
      "Once you complete the pathway program successfully, you'll be guaranteed entry into a partner university's degree program. There'll also be continuous guidance during this time to ensure you stay on track, helping you smoothly transition into your chosen academic path and life abroad.",
  },
];
