...
const AccomadationModal = () => {
  return (
    <div id="default-modal" aria-hidden="true" className="hidden fixed inset-0 z-50  justify-center items-center w-full h-full bg-gray-900 bg-opacity-50">
            ...
            <div className="w-3/5  px-4">
              <form action="#">
                ...
                <div className="sm:col-span-2">
                  <label htmlFor="description" className="block  mb-2 font-normal text-gray-900 dark:text-white">Message (optional)</label>
                ...
                <div>
                  ...
                  <button type="submit" className="text-white inline-flex items-center bg-primary-500 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
