...
const LeaguageOfExcellenceUniversity = ({
  ...
  return (
    <section className="">
      <div className="px-7 md:px-14  flex flex-col gap-6 mx-auto max-w-screen-2xl ">
        {/* Content */}
      ...
      <div className="flex gap-10 pl-7 md:pl-14 pt-8 md:pt-10 pb-5 overflow-x-auto   scrollbar-hide">
