...
const AbroaedPlusHero = () => {
    return (
        ...
        >
            ...
            <div className="absolute bottom-2  py-5  flex flex-col  justify-start  mx-auto px-12">
                ...
                <button className="bg-[#FDDA24] text-lg text-[#432205] hover:bg-yellow-300  py-2 rounded-lg font-semibold">
