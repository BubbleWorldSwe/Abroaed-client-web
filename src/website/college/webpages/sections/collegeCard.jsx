...
const CollegeCard = ({
  ...
  return (
    ...
    >
      ...
      {/* Content Section */}
      <div className="flex items-start justify-between ml-3 w-full">
        <div>
          <h5 className="text-[18px] line-clamp-2 font-semibold tracking-tight text-gray-primary dark:text-white">
            {item.name}
          </h5>
