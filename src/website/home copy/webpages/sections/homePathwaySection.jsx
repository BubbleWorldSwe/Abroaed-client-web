...
const HomePathwaySection = () => {
  ...
  return (
    <div className="">
      <section className=" relative px-7 md:px-10 mx-auto  h-full">
        <div className=" max-w-screen-2xl md:px-3 md:h-[550px] relative z-10 ">
          <div className="flex  md:flex-row flex-col  md:pt-10 gap-10 md:gap-4 md:h-[66vh] lg:h-[70vh]">
            {/* Left Child */}
            <div
              className="relative  flex-grow basis-[50%] group hover:basis-[90%] transition-all duration-300 ease-in-out rounded-lg  overflow-y-auto"
              onMouseEnter={() => {
                setIsHovered(true);
                setHoverOn("direct");
              }}
            ...
            >
              ...
              <div className="absolute bottom-3 left-10 px-5">
                ...
                {hoverOn === "direct" && isHovered && (
                  <div className="bg-opacity-50 pb-6 flex items-center justify-center text-white text-[12px] md:text-base opacity-0 group-hover:opacity-100 transition-opacity duration-300">
