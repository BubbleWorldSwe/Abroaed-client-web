            ...
            <div className="relative z-10">
                <section className="dark:bg-gray-900 relative px-10 mx-auto">
                    <div className=" mx-auto max-w-screen-2xl lg:grid lg:grid-cols-1 lg:py-16">
                        <div className="flex flex-col gap-16 text-gray-500 sm:text-lg dark:text-gray-400">
                            <div>
                                <p className="mb-4">
...
export default IvyLeaguesInfoSection