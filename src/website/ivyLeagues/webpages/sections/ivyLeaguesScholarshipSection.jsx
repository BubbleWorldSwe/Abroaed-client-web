...
const IvyLeaguesScholarshipSection = () => {
    return (
        <div className="relative z-10">
            <section className=" dark:bg-gray-900 relative px-10 mx-auto">
                <div className="gap-8 items-center py-1 px-4 mx-auto max-w-screen-2xl lg:grid lg:grid-cols  lg:px-6">
...
export default IvyLeaguesScholarshipSection