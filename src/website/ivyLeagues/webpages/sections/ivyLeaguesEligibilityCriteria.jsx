...
const IvyLeaguesEligibilityCriteria = () => {
    return (
                            ...
                            {Array(2).fill().map((_, index) => (
                                ...
                                >
                                    <div className="p-5">
                                        ...
                                        <h5 className="mb-5 text-xl font-semibold tracking-tight text-gray-900 dark:text-white">
                                            {/* {item.name} */}
                                            University Name
                                        </h5>
...
export default IvyLeaguesEligibilityCriteria