const IvyLeaguesLeadFormSection = () => {
  return (
    <section className=" relative isolate overflow-hidden z-10 px-10 mx-auto">
      <div className=" px-4 mx-auto  max-w-screen-2xl lg:py-24 dark:bg-gray-800 antialiased  relative z-20">
...
export default IvyLeaguesLeadFormSection;
