    ...
    <section className="">
      <div className="  py-6  pb-10 flex flex-col gap-6 mt-10 md:mt-8">
        ...
        <div className="relative  z-10">
          <h2
            className={`mb-2 text-[45px]  font-extrabold text-gray-primary dark:text-white`}
          >
            Contact Us
          </h2>
          ...
          <div className="grid grid-cols-1  md:justify-center md:grid-cols-2 gap-6  md:gap-10 pb-8 md:pb-16 pt-6 md:pt-10">
            <div className="flex relative flex-col gap-4 text-white bg-gray-primary py-8 hover:scale-[1.01] rounded-xl shadow-lg px-4 md:px-10">
              <div>
                <h5 className="text-[16px]  font-semibold">Corporate Office</h5>
                <p className=" text-base font-normal ">
                  Delhi Office B11, Block B, Qutab Institutional Area, New
                  Delhi, Delhi 110016
                </p>
              </div>
              <div>
                <h5 className="text-[16px]  font-semibold">Contact Number</h5>
                <p className=" text-base font-normal ">
                  📞 +91 73033 68821
                  <br />
                  📞 +91 73033 68820
              ...
              <div>
                ...
                <div className="flex flex-col gap-2">
                  <div>
                    ...
                    <p className=" text-base font-normal ">info@abroaed.com</p>
                  </div>
                  <div>
                    <h5 className="text-[16px]  font-semibold">Work With Us</h5>
                    <p className=" text-base font-normal ">
                      career@abroaed.com
                    </p>
                  </div>
