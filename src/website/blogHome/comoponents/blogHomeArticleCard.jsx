...
const BlogHomeArticleCard = ({ data }) => {
  ...
  return (
    <div className=" mx-auto w-full bg-white rounded-xl shadow-md dark:bg-gray-900 dark:border-gray-700">
      ...
      <div className="p-4">
        ...
        <h3
          className={`mb-1 text-[22px] font-semibold leading-tight  text-gray-primary `}
        >
        ...
        <div className=" mt-2">
          <button
            className="px-3 py-2 bg-[#fdda24] text-gray-700 font-semibold hover:bg-yellow-300 rounded-lg "
