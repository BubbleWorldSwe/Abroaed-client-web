import TextPrepAbroaedUpdateCard from "../../components/textPrepAbroaedUpdateCard"
import { articles } from "../../data"

const TestPrepAbroaedUpdateSection = () => {
    return (
            ...
            <div className="py-8 px-4 mx-auto  max-w-screen-2xl lg:py-24 dark:bg-gray-800 antialiased  relative z-20">
                ...
                <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6 mx-auto max-w-screen-2xl">
                    {articles.map((article, idx) => (
                        <TextPrepAbroaedUpdateCard article={article} key={idx} />
                    ))}
                </div>
            </div>
        </section>
...
export default TestPrepAbroaedUpdateSection