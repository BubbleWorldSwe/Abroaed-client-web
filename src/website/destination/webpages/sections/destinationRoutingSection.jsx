        ...
        <div className="flex justify-between max-w-screen-xl mx-auto items-center dark:bg-gray-800 sm:rounded-lg p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-5 relative">
          {destinatioRounting.map((path, index) => (
            <Link
              ...
              duration={500}
              offset={-120}
              className="relative cursor-pointer font-medium text-base text-[#52525B] transition-colors hover:text-blue-700 after:content-[''] after:absolute after:left-0 after:-bottom-6 after:h-[2px] after:w-full after:bg-blue-700 after:scale-x-0 after:transition-transform after:duration-300 hover:after:scale-x-100"
            >
              {path.sectionName}
            </Link>
          ))}
