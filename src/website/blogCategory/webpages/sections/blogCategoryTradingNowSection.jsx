    ...
    return (
        <div>
            <div className="relative z-10">
                <section className="dark:bg-gray-900 relative px-12 py-10 mx-auto">
                    <div className=" mx-auto max-w-screen-2xl lg:grid lg:grid-cols-1 ">
                        <aside
                            aria-label="Related articles"
                            className="  dark:bg-gray-800 antialiased"
                        >
                            <div className="px-4 mx-auto  grid grid-cols-2 gap-5 ">
                                <article className="flex gap-5 ">
                                    <div className="w-[22rem] h-48 flex-shrink-0  rounded-xl">
                                        <img
