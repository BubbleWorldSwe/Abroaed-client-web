...
import UniversityCardPhone from "../components/universityCardPhone";

const ExploreCollegesNavItemModalPhone = ({
  allDestinations,
  selectedDestination,
  selectedState,
  states,
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 py-2 max-h-[55vh] overflow-y-auto">
                {isLoading ? (
                  ...
                  filteredColleges?.map((college) => (
                    <UniversityCardPhone item={college} key={college?._id} />
                  ))
                ) : (
...
export default ExploreCollegesNavItemModalPhone;
