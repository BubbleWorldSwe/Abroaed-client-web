            ...
            <div className=" px-4 py-10 flex flex-col gap-6 mx-auto max-w-screen-2xl mt-5">
                ...
                <div className="relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3  gap-3 py-10 ">
                       {Array(3).fill().map((_,index)=>( <div key={index} className="flex flex-col p-6 mx-auto w-full text-start text-gray-900 bg-white rounded-lg border border-gray-200 shadow-xl dark:border-gray-700 xl:p-8 dark:text-white dark:bg-gray-800">
