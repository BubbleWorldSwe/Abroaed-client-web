...
import FileUploadModal from "../../Components/Modals/UploadDocumentModal-admin";
...
function StudentsTable() {
  ...
  return (
    <>
      <FileUploadModal isOpen={isAddModalOpen} onClose={handleCloseAddModal} />
              ...
              <div class="border-b dark:border-gray-700 mx-4">
                <div class="flex items-center justify-between space-x-4 pt-3">
                  <div class="flex-1 flex items-center space-x-3">
                    <h5 class="dark:text-white font-semibold"> All Students</h5>
                  </div>
                </div>
