                ...
                <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-2xl lg:grid lg:grid-cols lg:py-16 lg:px-6">
                    ...
                    <div className="grid grid-cols-2 gap-10 ">
                        <div>
                            ...
                            <p className="mb-3 text-lg w-10/12 text-gray-700 ">
                                ...
                                <div class=" w-11/12 ">
                                    <div class=" dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                                        <div class="overflow-x-auto">
                                            <table class="w-full  text-sm text-left text-gray-500 border-4 border-[#E4E4E7] dark:text-gray-400">
                                                <thead class="text-xs bg-[#E4E4E7] text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                                    <tr>
                                            ...
                                            <nav class="bg-[#E4E4E7] md:items-center space-y-3 md:space-y-0 p-4" aria-label="Table navigation">
...
export default DestinationExpanses;