...
function DestinationHero() {
  return (
    <div>
      <section className="bg-yellow-50 pb-8 antialiased dark:bg-gray-900 md:pb-16">
        <div className="bg-[url('https://images.alphacoders.com/124/1249032.jpg')] bg-cover bg-center bg-no-repeat dark:bg-[url('https://flowbite.s3.amazonaws.com/blocks/e-commerce/hero-ecommcerce-image-dark.jpg')]">
          <div className="relative z-10 mx-auto max-w-2xl px-4 pb-32 pt-8 text-center text-white lg:pt-16 xl:px-0">
            <h1 className="mb-4 text-4xl font-extrabold leading-tight tracking-tight text-white-900 dark:text-white lg:text-6xl">
              Study in USA
            </h1>
            <p className="mb-6 font-light text-white-800 dark:text-gray-400 md:text-lg lg:mb-8 lg:text-xl">
        ...
        <div className="-mt-20 px-4">
          <div className="mx-auto grid max-w-7xl grid-cols-2 gap-x-4 gap-y-8 rounded-lg border border-gray-200 bg-white py-8 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:grid-cols-3 md:grid-cols-4 md:p-8 lg:grid-cols-8">
            <div className="text-center">
              ...
              >
                <svg
                  className="h-5 w-5 text-gray-900 dark:text-white lg:h-8 lg:w-8"
                  aria-hidden="true"
