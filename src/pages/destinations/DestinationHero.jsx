...
function DestinationHero() {
  return (
    <div>
      <section class="bg-yellow-50 pb-8 antialiased dark:bg-gray-900 md:pb-16">
        <div class="bg-[url('https://images.alphacoders.com/124/1249032.jpg')] bg-cover bg-center bg-no-repeat dark:bg-[url('https://flowbite.s3.amazonaws.com/blocks/e-commerce/hero-ecommcerce-image-dark.jpg')]">
          <div class="relative z-10 mx-auto max-w-2xl px-4 pb-32 pt-8 text-center text-white lg:pt-16 xl:px-0">
            <h1 class="mb-4 text-4xl font-extrabold leading-tight tracking-tight text-white-900 dark:text-white lg:text-6xl">
              Study in USA
            </h1>
            <p class="mb-6 font-light text-white-800 dark:text-gray-400 md:text-lg lg:mb-8 lg:text-xl">
        ...
        <div class="-mt-20 px-4">
          <div class="mx-auto grid max-w-7xl grid-cols-2 gap-x-4 gap-y-8 rounded-lg border border-gray-200 bg-white py-8 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:grid-cols-3 md:grid-cols-4 md:p-8 lg:grid-cols-8">
            <div class="text-center">
              <a
                href="#"
                class="mx-auto mb-4 flex h-20 w-20 items-center justify-center rounded-lg border border-gray-200 bg-white hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600"
              >
                <svg
                  class="h-5 w-5 text-gray-900 dark:text-white lg:h-8 lg:w-8"
                  aria-hidden="true"
              ...
              <a href="#" class="mb-2 text-lg font-semibold text-gray-900 hover:underline dark:text-white">
                Fun Facts
              </a>
            </div>
            <div class="text-center">
