  ...
  return (
     <div>
                <section className=" dark:bg-gray-900 relative">
                    <div className="py-2 px-4 mx-auto  max-w-screen-2xl lg:py-16   dark:bg-gray-800 antialiased  relative z-20">
                    <aside
        aria-label="Related articles"
        className="py-8 lg:py-24  dark:bg-gray-800 antialiased"
      >
