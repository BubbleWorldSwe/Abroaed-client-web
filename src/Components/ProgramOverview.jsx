  ...
  return (
    <div className="mx-auto w-full max-w-screen-2xl relative">
      <section className="bg-white dark:bg-gray-900 relative">
        <div className="py-8   lg:py-16 lg:px-6 relative z-10 ">
          <div className=" text-left mb-8 lg:mb-16">
            <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
              What Sets Us Apart?
            </h2>
            <p className="font-light mt-2 text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">
              Explore the whole collection of open-source web components and
              elements built with the utility classes from Tailwind. Explore the
              whole collection of open-source web components and elements built
              with the utility classes from Tailwind. Explore the whole
              collection of open-source web components and elements built with
              the utility classes from Tailwind. Explore the whole collection of
              open-source web components and elements built with the utility
              classes from Tailwind. Explore the whole collection of open-source
              web components and elements built with the utility classes from
              Tailwind.
            </p>
          </div>
          <div>
                ...
                <div class="text-center md:max-w-3xl lg:text-left xl:shrink-0">
                  <div>
                    ...
                    <p class="mt-4 text-base font-normal text-gray-500 md:max-w-3xl md:mx-auto sm:text-xl dark:text-gray-400">
                      This book covers the latest design principles and
                      techniques, including responsive design, mobile interface
