  ...
  return (
    <div>
      <section class="bg-white dark:bg-gray-900 antialiased">
        <div class="max-w-screen-xl flex flex-col gap-3 px-4 py-8 mx-auto sm:py-16 lg:py-24">
          <div className="flex flex-col gap-2 py-4">
            <h2 class="text-3xl w-full items-center text-left  font-extrabold leading-tight text-black sm:text-4xl">
              Our Story
            </h2>
              ...
              <div id="deviceTabContent" class="mt-8">
                <div id="ios" role="tabpanel" aria-labelledby="ios-tab">
                  <div class="space-y-4 sm:space-y-6 lg:space-y-8">
                    <div>
                      <h2 class="text-3xl font-extrabold leading-tight text-black sm:text-4xl">
