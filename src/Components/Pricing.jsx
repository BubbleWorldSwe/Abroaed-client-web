      ...
      <section className="z-[999]">
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
            <h2 className="mb-4 text-4xl font-inter tracking-tight font-extrabold text-gray-900 dark:text-white">
              Designed for business teams like yours
            </h2>
            <p className="mb-5 font-inter font-light text-gray-500 sm:text-xl dark:text-gray-400">
          ...
          <div className="grid gap-8 xl:grid-cols-3 xl:gap-10">
            <div className="flex flex-col p-6 mx-auto max-w-xl text-center bg-white rounded-lg border border-gray-200 shadow xl:max-w-lg dark:border-gray-700 dark:bg-gray-800 xl:p-8">
              ...
              <a
                href="#"
                className="inline-flex justify-center items-center font-medium text-yellow-600 hover:text-yellow-800 dark:text-yellow-500 dark:hover:text-yellow-700"
              >
                Go to annual plan
                <svg
            ...
            <div className="flex flex-col p-6 mx-auto max-w-xl text-center bg-white rounded-lg border shadow xl:max-w-lg border-yellow-600 dark:bg-gray-800 xl:p-8">
              <div className="mb-2">
                <span className="py-1 px-3 text-sm text-yellow-800 bg-yellow-100 rounded dark:bg-yellow-200 dark:text-yellow-800">
                  Most popular
                </span>
              </div>
              <h3 className="mb-4 text-2xl font-medium text-gray-900 dark:text-white">
              ...
              <a
                href="#"
                className="text-white bg-yellow-600 hover:bg-yellow-700 focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 font-medium rounded-lg text-sm px-5 py-2.5 text-center my-8"
              >
                Get started
              </a>
