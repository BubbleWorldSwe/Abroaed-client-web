    ...
    return (
        <div className="w-full bg-[#fff] min-h-[90vh] px-5 py-10 ">
            ...
            <div className="bg-white mb-10 p-6 rounded-xl shadow-md">
                <div className="flex items-center gap-10">
                    <div className="flex justify-center">
                        <img className="w-12 object-cover h-12 rounded-full border-2 border-gray-300" src="https://media.istockphoto.com/id/1437816897/photo/business-woman-manager-or-human-resources-portrait-for-career-success-company-we-are-hiring.jpg?s=612x612&w=0&k=20&c=tyLvtzutRh22j9GqSGI33Z4HpIwv9vL_MZw_xOE19NQ=" alt="Rounded avatar" />
                        <div className="ml-4">
                    ...
                    <div className="flex flex-col  gap-3">
                        <div className="p-4 flex gap-3 text-center border border-gray-200 rounded-lg w-[20vw]">
                            ...
                            <div className="flex flex-col gap-1 text-start">
                                ...
                                <p className="text-xs text-gray-600">Next Counselling on 17/02</p>
                            </div>
                        </div>
                                    ...
                                    <div className="flex flex-col gap-4" key={index}>
                                        <div className="" role="">
                                            <button
                                                ...
                                                aria-selected={activeTab === index}
                                            >
                                                <span className={`px-2 py-1 rounded-full ${tabColors[tab.tabName] || "bg-gray-300"} text-${tab.tabName === 'Rejected' ? 'white' : '#27272A'}`}>
                                                    {tab.tabName}
                                                </span>
                                            </button>
                                        </div>
            ...
            <div className="bg-white p-4 rounded-lg border mb-6">
                <h2 className="text-2xl py-2 font-semibold border-b-2 border-gray-200  mb-3">Recently Viewed Colleges</h2>
            ...
            <div className=" p-4 rounded-lg border mb-6">
                <h2 className="text-2xl py-2 font-semibold border-b-2 border-gray-200  mb-3">Recently Viewed Courses</h2>
