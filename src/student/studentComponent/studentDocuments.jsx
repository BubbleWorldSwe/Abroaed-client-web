        ...
        <div className="w-full font-rethink bg-[#fff] min-h-[90vh] px-5 py-3">
            <div className="mb-5  bg-white dark:bg-gray-900 flex flex-col ">
                <div className="flex p-5 flex-col shadow-lg  w-full bg-white dark:bg-gray-800 relative  sm:rounded-lg">
                    <h2 className="text-2xl py-2 font-semibold  mb-3">Requested Documents</h2>
                    <div
                            ...
                            <tbody>
                                {[1, 2].map((member, index) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            <button
                                                className="p-2 bg-[#EDBD05] rounded hover:bg-yellow-300"
                                            >Upload Now</button>
                                        </td>
                                    </tr>
                                ))}
            ...
            <div className="flex p-5 flex-col shadow-lg  w-full bg-white dark:bg-gray-800 relative  sm:rounded-lg">
                    ...
                    <ul className="flex w-full -mb-px text-sm font-medium text-center" role="tablist">
                        {tabs.map((tab, index) => (
                            <li key={index} className="w-full" role="presentation">
                                <button
                                    className={`inline-block p-4 w-full text-base font-semibold rounded-t-lg ${activeTab === index ? 'text-black  border-b-2 border-blue-500' : 'text-gray-500 dark:text-gray-400 font-semibold hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300'}`}
                ...
                <div
                    className=" lg:max-w-[79vw]  mt-1 overflow-auto bg-white dark:bg-gray-800  shadow rounded"
                >
                    <table className="w-full border-2 rounded-lg text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead className=" text-[#71717A] font-rethink  bg-[#E4E4E7] dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                >
                                    ...
                                    <td className="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        <span
                                            ...
                                            style={{
                                                backgroundColor: "In-Review " ? "#FFFCC2" : "Rejected" ? "#DB4437" : "#0F9D58",
                                                text: ""
                                            }}
                                        >
                                            In-Review
