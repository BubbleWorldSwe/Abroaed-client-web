...
const StudentProfileEditModal = ({ isOpen,
    onClose, }) => {
                ...
                <div className="fixed  font-rethink inset-0 bg-black bg-opacity-50 z-30 flex justify-center items-center">
                    <div className="bg-white relative p-5 rounded-lg shadow-lg w-full max-w-xl py-7">
                        ...
                        <div className="flex items-center gap-4">
                            <img className="w-12 object-cover h-12 rounded-full" src="https://media.istockphoto.com/id/1476170969/photo/portrait-of-young-man-ready-for-job-business-concept.webp?a=1&b=1&s=612x612&w=0&k=20&c=-F_sZl6saA5wNg2OTdO3zcHZ3aQ2ml9Ru-PXGcUDdHg=" alt="" />
                            <div className=" dark:text-white">
                                <div className=" text-center px-2  max-w-min text-sm  bg-[#F3F4F6]">Premium </div>
                                <div className="text-[#111928] text-xl font-bold">Jese Leos</div>
                                <div className=" text-[#6B7280] text-base dark:text-gray-400 font-semibold">India</div>
                            </div>
                        </div>                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 p-4">
                            <TextInputField
                                label="Full Name"
                                name="fullName"
                                type="text"
