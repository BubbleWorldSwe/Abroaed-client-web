    ...
    return (
        <nav className="bg-white w-full border-b border-gray-300 px-10 py-3 flex items-center justify-between drop-shadow-md">
            ...
            <div className="flex items-center space-x-5">
                ...
                <button className="text-gray-500 hover:text-gray-700">
                    <img className="w-10 object-cover h-10 rounded-full border-2 border-gray-300" src="https://media.istockphoto.com/id/1437816897/photo/business-woman-manager-or-human-resources-portrait-for-career-success-company-we-are-hiring.jpg?s=612x612&w=0&k=20&c=tyLvtzutRh22j9GqSGI33Z4HpIwv9vL_MZw_xOE19NQ=" alt="Rounded avatar" />
                </button>
            </div>
        </nav>
    )
