...
const StudentPreferenceCourseCard = () => {
    const course = {
        ...
        fees: "₹2,00,000",
        intake: "August 2025",
        brief: "A comprehensive program covering frontend, backend, and database management using MERN stack."
    };


    return (
        <div className="max-w-sm flex-shrink-0  bg-white border border-gray-200 rounded-lg shadow p-5 dark:bg-gray-800 dark:border-gray-700 flex flex-col h-full">
