                        ...
                        <div>
                            <form onSubmit={''} className="space-y-6">
                                <div className="grid font-rethink grid-cols-1 gap-4 lg:grid-cols-3">
                                    ...
                                    <div>
                                        <label className="block text-sm font-semibold text-[#27272A] mb-1">Document Name</label>
                                        <select
                                    ...
                                    <div>
                                        <label className="block text-sm font-semibold text-[#27272A] mb-1">Document Title</label>
                                        <input
