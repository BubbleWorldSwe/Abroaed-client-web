    ...
    <div className="w-full mx-auto mb-8   p-5 bg-white rounded-lg shadow-lg">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="flex flex-col">
          ...
          <span className="text-[#6B7280] tracking-tight">{`${leadProfile?.user?.firstName} ${leadProfile?.user?.lastName}`}</span>
        </div>
        <div className="flex flex-col">
          <label className="font-semibold tracking-tight text-[#111928]">
            Phone Number
          </label>
          <span className="text-[#6B7280] tracking-tight">{`${leadProfile?.user?.mobile}`}</span>
        </div>
