        ...
        <div className="flex py-2 flex-col h-screen mx-auto max-w-screen-2xl bg-white dark:bg-gray-800 relative  sm:rounded-lg">
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="space-x-2">
              <button className="px-4 py-2 bg-gray-200 rounded-lg">Preview</button>
              <button className="px-4 py-2 bg-blue-500 text-white rounded-lg">Save Draft</button>
              <button className="px-4 py-2 bg-green-500 text-white rounded-lg">Publish</button>
            </div>
          </div>


          <div className="text-sm text-gray-500 mb-4">Last Updated Feb 21, 2025</div>
          <TextEditer />
