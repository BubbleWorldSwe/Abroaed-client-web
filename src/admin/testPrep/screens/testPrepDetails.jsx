...
const TestPrepDetails = () => {
    ...
    const sectionConfig = [
        { name: "About Exam", component: <AboutExamTestPrepModal /> },
    ...
    const modals = {
        section0: (
            <AboutExamTestPrepModal closeModal={closeModal} />
        ),
        section1: (
            <SimplifyThingsModal closeModal={closeModal} />
        ),
        section2: (
            <BatchesTestPrepModal closeModal={closeModal} />

        ),
        section3: (
            <FaqTestPrepModal closeModal={closeModal} />
        ),
    };
